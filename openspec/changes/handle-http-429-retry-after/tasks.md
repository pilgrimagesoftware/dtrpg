...
- [ ] 3.1 Record the required implementation order: `dtrpg-sdk/rust` before
      `dtrpg-app/rust`
- [ ] 3.2 Confirm the meta-repo submodule pointers advance only after both
