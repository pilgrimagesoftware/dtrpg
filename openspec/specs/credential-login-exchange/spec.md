...
## Purpose
Define the SDK operation that exchanges a DriveThruRPG account email and password for an application key, independent of the `api.drivethrurpg.com` client used for token-based operations.
