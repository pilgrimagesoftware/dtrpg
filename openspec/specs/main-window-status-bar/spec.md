# main-window-status-bar Specification

## Purpose
Define the desktop application's main window status bar, including library totals, active content area summary, theme picker, activity indicator, and notification indicator, as the shared structure child app repositories implement.
